...
export default function RemoveUserConfirmation({
  ...
  return (
    <Dialog open={open} onClose={() => onClose()} PaperProps={{
      ...
      <DialogContent>
        <Box sx={{display:'flex', alignItems:'center' , justifyContent:'center', pt:4, pb:2}}>
            <CheckCircleOutlineIcon sx={{color:'green', fontSize:60}}/>
        </Box>
        <Typography sx={{display:'flex', alignItems:'center' , justifyContent:'center',fontWeight: 'bold', fontSize:18}} >
          Are you sure you want to remove
        </Typography>
        <Typography sx={{display:'flex', alignItems:'center' , justifyContent:'center',fontWeight: 'bold', fontSize:18, fontStyle:'italic', color:'red', marginTop:"10px"}} >

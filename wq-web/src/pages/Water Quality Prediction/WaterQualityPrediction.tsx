...
const WaterQualityPrediction = (): JSX.Element => {
  ...
  const turbidity = [
    9.09, 9.09, 6.8, 6.6, 7.9, 8.1, 20.2, 157, 2.5, 3.2, 3.5, 3.5, 2.8, 3.2, 5,
    5.2, 3.7, 6.6, 19.8, 2.5, 3.1, 2.1, 2.3, 3.2, 7.1, 2.7, 2.5, 1.3, 1.3, 3.5,
    2.1, 3.3, 2.91, 3.8, 3.9, 7.81
  ];
  const ph = [
    6.8, 6.8, 6.8, 6.8, 6.8, 6.8, 6.7, 6.8, 6.7, 6.7, 6.8, 6.7, 6.8, 6.7, 6.8,
    6.6, 6.7, 6.7, 6.6, 6.6, 6.7, 6.7, 6.8, 6.7, 6.8, 6.9, 6.8, 6.7, 6.8, 6.7,
    6.6, 6.7, 6.7, 6.6, 6.7, 6.7
  ];
  const conductivity = [
    58.6, 58.6, 58.3, 56.1, 54.3, 54.3, 54.3, 54.3, 56.1, 54.3, 54.3, 54.3,
    54.9, 57.7, 56.2, 56, 54.2, 55.1, 57.8, 54.7, 59.1, 59, 55.1, 55, 55.7, 53,
    52.9, 57.6, 56.2, 55.5, 54.6, 58.9, 54.2, 55.1, 50.1, 51.2, 57.4
  ];
      ...
      >
        <Card className="lineChartCard">
          <Box width="100%">
            ...
            >
              {parameter.toUpperCase()} PREDICTIONS FOR{' '}
              {predictionPeriod === 7
                ? 'NEXT WEEK'
                : predictionPeriod === 14
                ? 'NEXT TWO WEEKS'
